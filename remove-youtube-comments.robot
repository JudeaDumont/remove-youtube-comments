...
Nix Those Comments Broh
    ...
    FOR    ${index}    IN RANGE    147483646
    	Wait Until Element Is Enabled  css=c-wiz > div > div > c-wiz > c-wiz > div > div:nth-child(1) > c-wiz:nth-child(2) > div > div > div > div > div > button > svg  1 minute
    	Wait Until Element Is Visible  css=c-wiz > div > div > c-wiz > c-wiz > div > div:nth-child(1) > c-wiz:nth-child(2) > div > div > div > div > div > button > svg  1 minute
